 ...
 ***********************************************/
#include <GL/glut.h> /* mac: GLUT, linux: GL*/
 ...
 ***********************************************/
#define WINDOW_TITLE            "CST8234 - Simple Particle Systems - ZAID VERSEY"
...
int main(int argc, char **argv)  {
    ...
    srand( time( NULL ) );/*seed for random*/
   	...
   	/*
     *  Create the window & basic initialiazation
